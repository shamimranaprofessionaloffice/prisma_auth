 ...
 * Model AuthProvider
 * -------------------------------------------------
 *    AUTH PROVIDERS — local, google, twitter etc.
 * --------------------------------------------------
 */
...
export type AuthProviderWhereInput = {
  ...
  provider?: Prisma.EnumAuthTypeFilter<"AuthProvider"> | $Enums.AuthType
...
export type AuthProviderScalarWhereWithAggregatesInput = {
  ...
  provider?: Prisma.EnumAuthTypeWithAggregatesFilter<"AuthProvider"> | $Enums.AuthType
...
export type AuthProviderUpdateInput = {
  ...
  provider?: Prisma.EnumAuthTypeFieldUpdateOperationsInput | $Enums.AuthType
...
export type AuthProviderOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "provider" | "providerId" | "userId" | "createdAt", ExtArgs["result"]["authProvider"]>
...
export interface AuthProviderFieldRefs {
  ...
  readonly provider: Prisma.FieldRef<"AuthProvider", 'AuthType'>
